...
// https://github.com/music-rec/FluidBottomNavigation-rn?organization=music-rec&organization=music-rec
...
// @ts-ignore
export class FluidBottomNavigation extends Component<ComponentProps> {
  ...
  animatedItemValues: Array<any> = [];
  animatedBubbleValues: Array<any> = [];
  animatedMiniBubbleValues: Array<any> = [];
  animatedImageValues: Array<any> = [];
