...
export const avatarSize = normalize(40);
export const snackbarHeight = 48;
...
export const fontSizeTitle = normalize(20);
export const fontSizeSubheading = 14;
export const fontSizeBody = normalize(14); // 14
export const fontSizeCaption = 12;
export const fontSizeButton = normalize(14); // 14;
