...
export type IconAlertRoundProps = SvgProps;
export type IconAlertRoundElement = React.ReactElement<IconAlertRoundProps>;

export const IconAlertRound = ({
                             color = '#000000',
                             height = 24,
                             width = 24,
                           }: IconAlertRoundProps) => (
  <Svg width={width} height={height} viewBox='0 0 105.27 89.6'>
    <G data-name='alert-round'>
      <Path
        fill={color}
