...
export type RateBarProps = ViewProps & ComponentProps;

export class RateBar extends React.Component<RateBarProps> {
  ...
  public render(): React.ReactNode {
    const { style, hint, ...restProps } = this.props;
    const { container, ...componentStyle } = styles;
