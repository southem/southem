...
import { IconRegistryService, IconProvider } from '@southem/icons';
...
describe('@icon-registry: service checks', () => {
  ...
  it('should register icon pack without overriding default', () => {
    ...
    expect(IconRegistryService.getIcon('home').type).toEqual('test-icon-pack-1');
  });
  ...
  it('should change default icon pack', () => {
    ...
    expect(IconRegistryService.getIcon('home').type).toEqual('test-icon-pack-2');
  });
  ...
  it('should return icon from specified pack', () => {
    expect(IconRegistryService.getIcon('home', 'test-icon-pack-2').type).toEqual('test-icon-pack-2');
  });
