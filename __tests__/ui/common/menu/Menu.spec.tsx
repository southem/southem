...
// @ts-ignore
import { IndexPath } from '@southem/ui/devsupport';
...
describe('@menu-item: component checks', () => {
  ...
  it('should render components passed to accessoryLeft or accessoryRight props', () => {
    const AccessoryLeft = (props): React.ReactElement<ImageProps> => (
      <Image
        {...props}
        source={{ uri: 'https://i.imgur.com/fill/png/128/star.png' }}
      />
    );
    ...
    const AccessoryRight = (props): React.ReactElement<ImageProps> => (
      <Image
        {...props}
        source={{ uri: 'https://i.imgur.com/fill/png/128/home.png' }}
      />
    );
    ...
    expect(accessoryLeft.props.source.uri).toEqual('https://i.imgur.com/fill/png/128/star.png');
    expect(accessoryRight.props.source.uri).toEqual('https://i.imgur.com/fill/png/128/home.png');
  });
